...
module.exports = {
  ...
  predictionioLogin: function predictionioLogin () {
    return (app.get('env') === 'production') ? new predictionio.Events({ appId: 1, accessKey: 'prod-access-key' }) : new predictionio.Events({ appId: 1, accessKey: 'eG5QurB_kAF6JMZavVIuTop-TwHwT8eicxMfvBQhKwzL5gdUyT-MuUtGPxm5xgfQ' })
  }
}
