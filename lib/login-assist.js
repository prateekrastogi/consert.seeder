...
module.exports = {
  ...
  recombeeLogin: function recombeeLogin () {
    return (app.get('env') === 'production') ? new Recombee.ApiClient('consertlive', 'Rm2nsWFEUhv3GgJrTzTL7YpSJcebeXuvZhU74TckFMog2W5XJUA1yhm93XSBdQYH') : new Recombee.ApiClient('conserttest', 'mklDUmoFh3hKbp4zXdd4efPcpwH9lr5pGC3qE5v7piYJBtciFxFyllmnuAlOv9w9')
  }
}
