...
module.exports = {
  ...
  predictionioLogin: function predictionioLogin () {
    return (app.get('env') === 'production') ? new predictionio.Events({ appId: 1, accessKey: 'prod-access-key' }) : new predictionio.Events({ appId: 1, accessKey: 'rALQLRMAj7HVkDrYZrE471aZXPLt_iyzfDnxydUTPnmzG7uy_jBALWKxN29Vr3UZ' })
  }
}
