...
module.exports = {
  ...
  predictionioLogin: function predictionioLogin () {
    return (app.get('env') === 'production') ? new predictionio.Events({ appId: 1, accessKey: 'prod-access-key' }) : new predictionio.Events({ appId: 1, accessKey: 'eTFg9NBwucZ3TOmyHw9cqMsJElW8Tkj6I22mbM-ZIfJJ1jOLt0CnDa694hBjfP-F' })
  }
}
