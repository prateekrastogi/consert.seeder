...
module.exports = {
  ...
  predictionioLogin: function predictionioLogin () {
    return (app.get('env') === 'production') ? new predictionio.Events({ appId: 1, accessKey: 'prod-access-key' }) : new predictionio.Events({ appId: 1, accessKey: 'LCUHdnTrZfkiZZE_z1j1BRO4bjX-GsI6VpEkW-VxXVhL9x8jfP6qvtwCra5Hp_em' })
  }
}
