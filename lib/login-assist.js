...
module.exports = {
  ...
  predictionioLogin: function predictionioLogin () {
    return (app.get('env') === 'production') ? new predictionio.Events({ appId: 1, accessKey: 'prod-access-key' }) : new predictionio.Events({ appId: 1, accessKey: 'HD6JEkK2Q3HFGAM7e01fqWrinxdR1_XMcZFn4yfc5op4WrSCXiRppsRIcZf5bAn1' })
  }
}
