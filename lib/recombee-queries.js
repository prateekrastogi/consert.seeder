...
module.exports = {
  ...
  setItemProperties: function setItemProperties () {
    const itemId = Rx.Observable.fromPromise(recombeeClient.send(new recombeeRqs.AddItemProperty('itemId', 'string')))
    ...
    Rx.Observable.concat(itemId, itemType, kind, etag, contentDetailsDuration, contentDetailsDimension, contentDetailsDefinition, contentDetailsLicensedContent, contentDetailsCaption, contentDetailsProjection,
