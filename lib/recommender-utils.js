...
const concurrentViewersBinEdges = [10, 100, 1000, 10000, 100000, 1000000, 10000000, 100000000, 1000000000, 10000000000, 100000000000]
...
exports.convertMediaItemToRecommenderMediaItem = function convertMediaItemToRecommenderMediaItem (mediaItem) {
  const recommenderMediaItem = {
    ...
    'snippet-tags': mediaItem.snippet.tags ? [mediaItem.snippet.tags] : [],
    'snippet-categoryId': mediaItem.snippet.categoryId ? [mediaItem.snippet.categoryId] : [],
    'snippet-liveBroadcastContent': mediaItem.snippet.liveBroadcastContent ? [mediaItem.snippet.liveBroadcastContent] : [],
    'snippet-defaultLanguage': mediaItem.snippet.defaultLanguage ? [mediaItem.snippet.defaultLanguage] : [],
    ...
    'liveStreamingDetails-concurrentViewers': mediaItem.liveStreamingDetails ? binningDelegate('liveStreamingDetails-concurrentViewers', parseInt(mediaItem.liveStreamingDetails.concurrentViewers), concurrentViewersBinEdges) : [],
    'liveStreamingDetails-activeLiveChatId': mediaItem.liveStreamingDetails ? [mediaItem.liveStreamingDetails.activeLiveChatId] : [],
    'artists-ids': mediaItem.ArtistsIds ? mediaItem.ArtistsIds : [],
    'genres': mediaItem.ArtistsGenres ? mediaItem.ArtistsGenres : [],
    'artists-names': mediaItem.ArtistsNames ? mediaItem.ArtistsNames : [],
    'artists-popularity': mediaItem.ArtistsPopularity ? binningDelegate('artists-popularity', mediaItem.ArtistsPopularity, artistPopularityBinEdges) : [],
    'relatedItems': mediaItem.relatedArtists ? mediaItem.relatedArtists : [],
    'artists-type': mediaItem.ArtistsType ? mediaItem.ArtistsType : [],
