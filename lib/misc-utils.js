...
// Just another variant of the recursiveDeferredObservable using timeout to efficiently and correctly work with observables that don't have default baked in rx interval
exports.recursiveTimeOutDeferredObservable = function recursiveTimeOutDeferredObservable (observable, WAIT_TILL_NEXT_REQUEST) {
  return observable.timeoutWith(4 * WAIT_TILL_NEXT_REQUEST, Rx.Observable.defer(() => recursiveTimeOutDeferredObservable(observable, WAIT_TILL_NEXT_REQUEST)))
}
